...
AUTH_MODE="${ATLAS_AUTH_MODE:-disabled}"
ENV_VARS="ATLAS_DEMAND_REPOSITORY=${ATLAS_DEMAND_REPOSITORY},ATLAS_FIRESTORE_PROJECT=${ATLAS_FIRESTORE_PROJECT:-},ATLAS_FIRESTORE_DATABASE=${FIRESTORE_DATABASE},ATLAS_FIRESTORE_COLLECTION=${ATLAS_FIRESTORE_COLLECTION:-},ATLAS_AUTH_MODE=${AUTH_MODE},ATLAS_ALLOWED_ORIGINS=${ATLAS_ALLOWED_ORIGINS:-http://localhost:3000},ATLAS_ALLOWED_ORIGIN_REGEX=${ATLAS_ALLOWED_ORIGIN_REGEX:-https://.*\\.run\\.app}"
